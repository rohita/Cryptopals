...
class Englishness {
    ...
    // The frequencies are from the following wikipedia page:
    // https://en.wikipedia.org/wiki/Letter_frequency#Relative_frequencies_of_letters_in_the_English_language
    //
    
    static let FREQUENCY_TABLE: [String: Double] = [
        " ":  0.12705, "a":  0.08167, "b":  0.01492, "c":  0.02782, "d":  0.04253, "e":  0.12702,
        "f":  0.02228, "g":  0.02015, "h":  0.06094, "i":  0.06966, "j":  0.00153, "k":  0.00772,
        ...
        /*
         ...
         So I am going to set values for most common punctuations.
         */
